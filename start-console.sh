...
declare -A plugins=(["monitoring-plugin"]="https://github.com/openshift/monitoring-plugin.git", ["kubevirt-plugin"]="https://github.com/kubevirt-ui/kubevirt-plugin.git")
declare -A runningPlugins=(["podman-linux"]="networking-console-plugin=http://localhost:9001", ["podman"]="networking-console-plugin=http://host.containers.internal:9001", ["docker"]="networking-console-plugin=http://host.docker.internal:9001")
